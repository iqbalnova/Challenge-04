import { View, Text, Image, StyleSheet, Alert, ActivityIndicator, RefreshControl } from 'react-native'
  ...
  return (
      <ScrollView 
        ...
        style={styles.container}>
          ...
          <View style={{ justifyContent:'center', alignItems: 'center', marginTop: ms(10), marginBottom: ms(5) }}>
            <Poppins size={ms(14)}>Dont have an account?</Poppins>
          </View>
          
          <TouchableOpacity onPress={() => navigation.navigate('Register')}>
            <Text style={{textAlign: 'center', color: 'blue', fontSize:ms(16), fontWeight:'bold'}}>Register</Text>
          </TouchableOpacity>
      </ScrollView>
    )
  }
