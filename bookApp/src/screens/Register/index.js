import { View, Text, Image, StyleSheet, Alert, RefreshControl, ActivityIndicator } from 'react-native'
  ...
  return (
    ...
    style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Login')}>
        <Text style={{textAlign: 'center', color: 'blue', fontSize:ms(16), fontWeight:'bold'}}>Login</Text>
      </TouchableOpacity>
    </ScrollView>
  )
}
