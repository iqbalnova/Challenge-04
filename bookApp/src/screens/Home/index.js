        ...
        <View style={{width: ms(130),
          ...
          <View style={{padding:ms(10), alignContent: 'space-around'}}>
            ...
            <View>
              ...
              prefix="Rp "
              renderText={formattedValue => <Poppins>{formattedValue}</Poppins>} />
            </View>
    ...
    return (
      <View>
        <View style={{margin: ms(10), flexDirection:'row', marginTop: ms(10)}}>
          ...
          <Poppins type='Bold' size={17} >{name}!</Poppins>
        </View>
  ...
  if(loading){
    return(
      <View style={{ flex:1,backgroundColor:'#fff', justifyContent:'center', alignItems:'center' }}>
        <LottieView style={{ flex:1 }} source={require('../../assets/animation/readbook.json')} autoPlay loop />
      </View>
    )
  }
      ...
      <FlatList
          ...
          renderItem={({item}) => (
            <TouchableOpacity style={{
              ...
              margin: ms(10),
              elevation: 2,
              borderRadius: ms(10)}} onPress={() => getMovieByID(item)}>
              <View>
                <Image 
                source={{uri: `${item.cover_image}`}}
              ...
              <View style={{ 
                ...
                <View style={{ marginBottom: ms(10) }}>
                  <Poppins type='Bold' size={15}>{item.title}</Poppins>
                </View>
